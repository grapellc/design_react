import { Switch as SwitchPrimitive, useSwitchContext } from "@grape_design_react/react-switch";
import { switchStyle, type SwitchVariantProps } from "@grape_design_react/css/recipes/switch";
import { switchmark, type SwitchmarkVariantProps } from "@grape_design_react/css/recipes/switchmark";
...
export const SwitchRoot = React.forwardRef<HTMLLabelElement, SwitchRootProps>(
  ({ className, ...props }, ref) => {
    if (
      ...
      console.warn(
        `[SEED Design System] Switch size='${props.size}' is deprecated and will be removed in @grape_design_react/react@1.3.0. Use size='${props.size === "small" ? "16" : "32"}' instead.`,
      );
    }
