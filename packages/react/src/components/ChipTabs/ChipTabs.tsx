import { chipTabs, type ChipTabsVariantProps } from "@grape_design_react/css/recipes/chip-tabs";
import { Tabs as TabsPrimitive } from "@grape_design_react/react-tabs";
...
export const ChipTabsRoot = forwardRef<HTMLDivElement, ChipTabsRootProps>(
  ({ className, ...props }, ref) => {
    if (process.env.NODE_ENV !== "production" && props.variant === "brandSolid") {
      console.warn(
        "[SEED Design System] ChipTabs variant='brandSolid' is deprecated and will be removed in @grape_design_react/react@1.3.0. Use variant='neutralSolid' or variant='neutralOutline' instead.",
      );
    }
