import type {
  ...
  Shadow,
  ScopedColorBanner,
} from "@grape_design_react/css/vars";
...
function handleDisplay(display: string | undefined) {
  ...
  if (process.env.NODE_ENV !== "production") {
    if (display === "inlineFlex" || display === "inlineBlock") {
      console.warn(
        `[SEED Design System] display='${display}' is deprecated and will be removed in @grape_design_react/react@1.3.0. Use display='${display === "inlineFlex" ? "inline-flex" : "inline-block"}' instead.`,
      );
    }
  }
...
function handleFlexDirection(flexDirection: string | undefined) {
  ...
  if (process.env.NODE_ENV !== "production") {
    if (flexDirection === "rowReverse" || flexDirection === "columnReverse") {
      console.warn(
        `[SEED Design System] flexDirection='${flexDirection}' is deprecated and will be removed in @grape_design_react/react@1.3.0. Use flexDirection='${flexDirection === "rowReverse" ? "row-reverse" : "column-reverse"}' instead.`,
      );
    }
  }
...
function handleJustifyContent(justifyContent: string | undefined) {
  ...
  if (process.env.NODE_ENV !== "production") {
    if (justifyContent === "flexStart" || justifyContent === "flexEnd") {
      console.warn(
        `[SEED Design System] justifyContent='${justifyContent}' is deprecated and will be removed in @grape_design_react/react@1.3.0. Use justifyContent='${justifyContent === "flexStart" ? "flex-start" : "flex-end"}' instead.`,
      );
    }
    if (justifyContent === "spaceBetween" || justifyContent === "spaceAround") {
      console.warn(
        `[SEED Design System] justifyContent='${justifyContent}' is deprecated and will be removed in @grape_design_react/react@1.3.0. Use justifyContent='${justifyContent === "spaceBetween" ? "space-between" : "space-around"}' instead.`,
      );
    }
  }
...
function handleAlignItems(alignItems: string | undefined) {
  ...
  if (process.env.NODE_ENV !== "production") {
    if (alignItems === "flexStart" || alignItems === "flexEnd") {
      console.warn(
        `[SEED Design System] alignItems='${alignItems}' is deprecated and will be removed in @grape_design_react/react@1.3.0. Use alignItems='${alignItems === "flexStart" ? "flex-start" : "flex-end"}' instead.`,
      );
    }
  }
