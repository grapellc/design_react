...
The `@grape_design_react/icon` is a command-line tool for generating seed icons.

```bash
npm install --dev @grape_design_react/icon

# or

yarn add -D @grape_design_react/icon
```
