# @grape_design_react/react-theming
...
```console
$ npm install @grape_design_react/react-theming
$ bun add @grape_design_react/react-theming
```
...
import {
  ...
  ThemeContext,
  useThemeBehavior,
} from "@grape_design_react/react-theming";
...
// 변경하기
import { useTheme } from "@grape_design_react/react-theming";
