import type { ScopedColorBg, ScopedColorPalette, ScopedColorBanner } from "@grape_design_react/css/vars";
import { vars } from "@grape_design_react/css/vars";

/**
 * A minimal subset of `StyleProps` from `@grape_design_react/react`.
