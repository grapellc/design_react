...
type GetItemPropsReturn = ReturnType<UseSegmentedControlReturn["getItemProps"]>;
declare function useSegmentedControl(props: UseSegmentedControlProps): {
    value: string;
...
interface SegmentedControlRootProps extends UseSegmentedControlProps, PrimitiveProps, Omit<react.HTMLAttributes<HTMLDivElement>, "defaultValue"> {
}
...
interface SegmentedControlItemProps extends UseSegmentedControlItemProps, PrimitiveProps, Omit<react.InputHTMLAttributes<HTMLLabelElement>, "value"> {
}
declare const SegmentedControlItem: react.ForwardRefExoticComponent<UseSegmentedControlItemProps & react.RefAttributes<HTMLLabelElement>>;
interface SegmentedControlItemHiddenInputProps extends PrimitiveProps, react.HTMLAttributes<HTMLInputElement> {
}
declare const SegmentedControlItemHiddenInput: react.ForwardRefExoticComponent<SegmentedControlItemHiddenInputProps & react.RefAttributes<HTMLInputElement>>;

interface UseSegmentedControlContext extends UseSegmentedControlReturn {
}
declare function useSegmentedControlContext<T extends boolean | undefined = true>({ strict, }?: {
    strict?: T;
}): T extends false ? UseSegmentedControlContext | null : UseSegmentedControlContext;

interface UseSegmentedControlItemContext extends GetItemPropsReturn {
}
declare function useSegmentedControlItemContext<T extends boolean | undefined = true>({ strict, }?: {
    strict?: T;
}): T extends false ? UseSegmentedControlItemContext | null : UseSegmentedControlItemContext;

declare namespace SegmentedControl_namespace {
  export { SegmentedControlItem as Item, SegmentedControlItemHiddenInput as ItemHiddenInput, SegmentedControlRoot as Root };
  export type { SegmentedControlItemHiddenInputProps as ItemHiddenInputProps, SegmentedControlItemProps as ItemProps, SegmentedControlRootProps as RootProps };
}

export { SegmentedControl_namespace as SegmentedControl, SegmentedControlItem, SegmentedControlItemHiddenInput, SegmentedControlRoot, useSegmentedControlContext, useSegmentedControlItemContext };
export type { SegmentedControlItemHiddenInputProps, SegmentedControlItemProps, SegmentedControlRootProps, UseSegmentedControlContext, UseSegmentedControlItemContext };
