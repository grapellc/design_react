...
interface CreateSnackbarOptions {
    /**
...
interface UseSnackbarProps extends UseSnackbarStateProps {
}
type UseSnackbarReturn = ReturnType<typeof useSnackbar>;
declare function useSnackbar(props: UseSnackbarProps): {
    refs: {
        regionRef: react.MutableRefObject<HTMLElement>;
    };
    visible: boolean;
    queue: CreateSnackbarOptions[];
    currentSnackbar: CreateSnackbarOptions;
    overlapTracker: {
        upsert: (id: string, el: Element) => void;
...
interface SnackbarRootProviderProps extends UseSnackbarProps {
    children: react.ReactNode;
}
declare const SnackbarRootProvider: ({ children, pauseOnInteraction, }: SnackbarRootProviderProps) => react_jsx_runtime.JSX.Element;
interface SnackbarRegionProps extends PrimitiveProps, react.HTMLAttributes<HTMLDivElement> {
}
declare const SnackbarRegion: react.ForwardRefExoticComponent<SnackbarRegionProps & react.RefAttributes<HTMLDivElement>>;
type SnackbarRendererProps = {};
declare const SnackbarRenderer: (_props: SnackbarRendererProps) => react.ReactNode;
interface SnackbarRootProps extends PrimitiveProps, react.HTMLAttributes<HTMLDivElement> {
}
declare const SnackbarRoot: react.ForwardRefExoticComponent<SnackbarRootProps & react.RefAttributes<HTMLDivElement>>;
interface SnackbarCloseButtonProps extends PrimitiveProps, react.ButtonHTMLAttributes<HTMLButtonElement> {
}
declare const SnackbarCloseButton: react.ForwardRefExoticComponent<SnackbarCloseButtonProps & react.RefAttributes<HTMLButtonElement>>;
interface SnackbarAvoidOverlapProps {
    children: react.ReactElement;
}
declare const SnackbarAvoidOverlap: (props: SnackbarAvoidOverlapProps) => react.ReactElement<any, string | react.JSXElementConstructor<any>>;

interface UseSnackbarContext extends UseSnackbarReturn {
}
declare function useSnackbarContext<T extends boolean | undefined = true>({ strict, }?: {
    strict?: T;
}): T extends false ? UseSnackbarContext | null : UseSnackbarContext;

declare namespace Snackbar_namespace {
  export { SnackbarAvoidOverlap as AvoidOverlap, SnackbarCloseButton as CloseButton, SnackbarRegion as Region, SnackbarRenderer as Renderer, SnackbarRoot as Root, SnackbarRootProvider as RootProvider };
  export type { SnackbarAvoidOverlapProps as AvoidOverlapProps, SnackbarCloseButtonProps as CloseButtonProps, SnackbarRegionProps as RegionProps, SnackbarRendererProps as RendererProps, SnackbarRootProps as RootProps, SnackbarRootProviderProps as RootProviderProps };
}

export { Snackbar_namespace as Snackbar, SnackbarAvoidOverlap, SnackbarCloseButton, SnackbarRegion, SnackbarRenderer, SnackbarRoot, SnackbarRootProvider, useSnackbarContext };
export type { CreateSnackbarOptions, SnackbarAvoidOverlapProps, SnackbarCloseButtonProps, SnackbarRegionProps, SnackbarRendererProps, SnackbarRootProps, SnackbarRootProviderProps, UseSnackbarContext };
