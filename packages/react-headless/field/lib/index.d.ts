...
declare function useField(props: UseFieldProps): {
    refs: {
        label: (node: HTMLLabelElement | null) => void;
...
interface FieldRootProps extends UseFieldProps, PrimitiveProps, react.HTMLAttributes<HTMLDivElement> {
}
declare const FieldRoot: react.ForwardRefExoticComponent<FieldRootProps & react.RefAttributes<HTMLDivElement>>;
interface FieldLabelProps extends PrimitiveProps, react.HTMLAttributes<HTMLLabelElement> {
}
declare const FieldLabel: react.ForwardRefExoticComponent<FieldLabelProps & react.RefAttributes<HTMLLabelElement>>;
interface FieldDescriptionProps extends PrimitiveProps, react.HTMLAttributes<HTMLSpanElement> {
}
declare const FieldDescription: react.ForwardRefExoticComponent<FieldDescriptionProps & react.RefAttributes<HTMLSpanElement>>;
interface FieldErrorMessageProps extends PrimitiveProps, react.HTMLAttributes<HTMLDivElement> {
}
declare const FieldErrorMessage: react.ForwardRefExoticComponent<FieldErrorMessageProps & react.RefAttributes<HTMLDivElement>>;

interface UseFieldContext extends UseFieldReturn {
}
declare function useFieldContext<T extends boolean | undefined = true>({ strict, }?: {
    strict?: T;
}): T extends false ? UseFieldContext | null : UseFieldContext;

declare namespace Field_namespace {
  export { FieldDescription as Description, FieldErrorMessage as ErrorMessage, FieldLabel as Label, FieldRoot as Root };
  export type { FieldDescriptionProps as DescriptionProps, FieldErrorMessageProps as ErrorMessageProps, FieldLabelProps as LabelProps, FieldRootProps as RootProps };
}

export { Field_namespace as Field, FieldDescription, FieldErrorMessage, FieldLabel, FieldRoot, useFieldContext };
export type { FieldDescriptionProps, FieldErrorMessageProps, FieldLabelProps, FieldRootProps, UseFieldContext };
