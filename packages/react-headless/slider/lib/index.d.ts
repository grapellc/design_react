...
interface UseSliderProps extends UseSliderStateProps {
    /**
     * @default false
     */
    disabled?: boolean;
...
declare function useSlider({ disabled, readOnly, invalid, name, jumpMultiplier, getAriaValuetext, getAriaLabel, getAriaLabelledby, getValueIndicatorLabel, valueIndicatorTrigger, dragStartDelayInMilliseconds, ...props }: UseSliderProps): {
    min: number;
    max: number;
    step: number;
    allowedValues: number[];
    ...
    readOnly: boolean;
    refs: {
        root: react.Dispatch<react.SetStateAction<HTMLElement>>;
    };
    isDragging: boolean;
    rootProps: {
    ...
    getThumbRef: (index: number) => RefCallback<HTMLElement>;
    ...
    getValueIndicatorProps: (index: number) => {
        rootProps: {
            dir?: string | undefined;
            defaultChecked?: boolean | undefined;
            defaultValue?: string | number | readonly string[] | undefined;
    ...
    updateValues: (value: number, atIndex: number, options?: {
        commit?: boolean;
    }) => void;
};

interface SliderRootProps extends UseSliderProps, PrimitiveProps, Omit<react.HTMLAttributes<HTMLDivElement>, "dir"> {
}
declare const SliderRoot: react.ForwardRefExoticComponent<SliderRootProps & react.RefAttributes<HTMLDivElement>>;
interface SliderRangeProps extends PrimitiveProps, react.HTMLAttributes<HTMLDivElement> {
}
declare const SliderRange: react.ForwardRefExoticComponent<SliderRangeProps & react.RefAttributes<HTMLDivElement>>;
interface SliderThumbProps extends PrimitiveProps, react.HTMLAttributes<HTMLDivElement> {
    thumbIndex: number;
}
declare const SliderThumb: react.ForwardRefExoticComponent<SliderThumbProps & react.RefAttributes<HTMLDivElement>>;
interface SliderHiddenInputProps extends PrimitiveProps, react.InputHTMLAttributes<HTMLInputElement> {
    thumbIndex: number;
}
declare const SliderHiddenInput: react.ForwardRefExoticComponent<SliderHiddenInputProps & react.RefAttributes<HTMLInputElement>>;
interface SliderTickProps extends PrimitiveProps, react.HTMLAttributes<HTMLDivElement> {
    value: number;
}
declare const SliderTick: react.ForwardRefExoticComponent<SliderTickProps & react.RefAttributes<HTMLDivElement>>;
interface SliderMarkerProps extends PrimitiveProps, react.HTMLAttributes<HTMLDivElement> {
    value: number;
}
declare const SliderMarker: react.ForwardRefExoticComponent<SliderMarkerProps & react.RefAttributes<HTMLDivElement>>;
interface SliderValueIndicatorRootProps extends PrimitiveProps, react.HTMLAttributes<HTMLDivElement> {
    thumbIndex: number;
}
declare const SliderValueIndicatorRoot: react.ForwardRefExoticComponent<SliderValueIndicatorRootProps & react.RefAttributes<HTMLDivElement>>;
interface SliderValueIndicatorLabelProps extends PrimitiveProps, react.HTMLAttributes<HTMLSpanElement> {
    thumbIndex: number;
}
declare const SliderValueIndicatorLabel: react.ForwardRefExoticComponent<SliderValueIndicatorLabelProps & react.RefAttributes<HTMLSpanElement>>;

declare namespace Slider_namespace {
  export { SliderHiddenInput as HiddenInput, SliderMarker as Marker, SliderRange as Range, SliderRoot as Root, SliderThumb as Thumb, SliderTick as Tick, SliderValueIndicatorLabel as ValueIndicatorLabel, SliderValueIndicatorRoot as ValueIndicatorRoot };
  export type { SliderHiddenInputProps as HiddenInputProps, SliderMarkerProps as MarkerProps, SliderRangeProps as RangeProps, SliderRootProps as RootProps, SliderThumbProps as ThumbProps, SliderTickProps as TickProps, SliderValueIndicatorLabelProps as ValueIndicatorLabelProps, SliderValueIndicatorRootProps as ValueIndicatorRootProps };
}

interface UseSliderContext extends UseSliderReturn {
}
declare function useSliderContext<T extends boolean | undefined = true>({ strict, }?: {
    strict?: T;
}): T extends false ? UseSliderContext | null : UseSliderContext;

export { Slider_namespace as Slider, SliderHiddenInput, SliderMarker, SliderRange, SliderRoot, SliderThumb, SliderTick, SliderValueIndicatorLabel, SliderValueIndicatorRoot, useSliderContext };
export type { SliderHiddenInputProps, SliderMarkerProps, SliderRangeProps, SliderRootProps, SliderThumbProps, SliderTickProps, SliderValueIndicatorLabelProps, SliderValueIndicatorRootProps };
