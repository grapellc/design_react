...
function useSliderState({ min, max, step = 1, allowedValues, minStepsBetweenThumbs = 0, values: propValues, defaultValues: propDefaultValues, onValuesCommit, onValuesChange, dir = "ltr" }) {
    ...
    const [rootEl, rootRef] = React.useState(null);
    const rectRef = React.useRef(undefined);
    const dragTimerRef = React.useRef(null);
    const pointerDownPosition = React.useRef(0);
    const thumbRefsMap = React.useRef(new Map());
    const valueIndicatorRootRefsMap = React.useRef(new Map());
    const firstThumbSize = reactUseSize.useSize(thumbRefsMap.current.get(0) ?? null);
    const rootSize = reactUseSize.useSize(rootEl);
    const valueIndicatorRootSizes = useElementSizesMap(valueIndicatorRootRefsMap);
    const [values, setValues] = reactUseControllableState.useControllableState({
        prop: propValues,
    ...
    const uncommittedValuesRef = React.useRef(null);
    const [isHovered, setIsHovered] = React.useState(false);
    const [isActive, setIsActive] = React.useState(false); // actual active state regardless of disabled/readOnly
    const [isDragging, setIsDragging] = React.useState(false);
    const [isPointerDown, setIsPointerDown] = React.useState(false);
    const [openThumbIndex, setOpenThumbIndex] = React.useState(null);
    const [activeThumbIndex, setActiveThumbIndex] = React.useState(null);
    const [shownIndicators, setShownIndicators] = React.useState(new Set());
    const updateValues = React.useCallback((value, atIndex, options)=>{
        const nextValue = (()=>{
    ...
    const getValueFromPointer = React.useCallback((pointerPosition)=>{
   ...
   */ const handleSlideStart = React.useCallback((value)=>{
   ...
   */ const handleSlideMove = React.useCallback((value)=>{
   ...
   */ const setToStart = React.useCallback(()=>{
   ...
   */ const setToEnd = React.useCallback(()=>{
   ...
   */ const adjustValueByStep = React.useCallback((atIndex, direction, multiplier = 1)=>{
...
function useSlider({ disabled, readOnly, invalid, name, jumpMultiplier = 10, getAriaValuetext, getAriaLabel, getAriaLabelledby, getValueIndicatorLabel = ({ value })=>value, valueIndicatorTrigger = "active", dragStartDelayInMilliseconds = 150, ...props }) {
    ...
    const stateProps = React.useMemo(()=>domUtils.elementProps({
            "data-hover": domUtils.dataAttr(api.isHovered),
            "data-active": domUtils.dataAttr(api.isActive),
            "data-disabled": domUtils.dataAttr(disabled),
            "data-readonly": domUtils.dataAttr(readOnly),
            "data-invalid": domUtils.dataAttr(invalid),
            "data-dragging": domUtils.dataAttr(api.isDragging),
    ...
    const getHasEverBeenShown = React.useCallback((index)=>api.shownIndicators.has(index), [
        api.shownIndicators
    ]);
    const rootProps = React.useMemo(()=>domUtils.elementProps({
            ...stateProps,
            dir: api.dir,
            onPointerLeave: ()=>{
    ...
    const rangeProps = React.useMemo(()=>{
    ...
    const getThumbProps = React.useCallback((index)=>{
        const value = api.values[index];
        if (value === undefined) return domUtils.elementProps({});
        ...
        return domUtils.elementProps({
            ...
            "data-thumb-dragging": domUtils.dataAttr(api.isDragging && api.valueIndexToChangeRef.current === index),
            "data-value-indicator-shown": domUtils.dataAttr(hasEverBeenShown),
    ...
    const getHiddenInputProps = React.useCallback((index)=>{
        const value = api.values[index];
        if (value === undefined) return domUtils.inputProps({});
    ...
    const getThumbRef = React.useCallback((index)=>(element)=>{
            if (!element) {
    ...
    const getTickProps = React.useCallback((value)=>{
        const percent = convertValueToPercentage(value, api.min, api.max);
    ...
    const getMarkerProps = React.useCallback((value)=>{
        const percent = convertValueToPercentage(value, api.min, api.max);
    ...
    const getValueIndicatorProps = React.useCallback((index)=>{
        const value = api.values[index];
        ...
        return {
            rootProps: domUtils.elementProps({
                ...
                "aria-hidden": true,
                "data-thumb-dragging": domUtils.dataAttr(api.isDragging && api.valueIndexToChangeRef.current === index),
                "data-value-indicator-shown": domUtils.dataAttr(isShown),
                "data-indicator-ever-shown": domUtils.dataAttr(hasEverBeenShown),
                style: {
...
const SliderContext = /*#__PURE__*/ React.createContext(null);
...
const SliderRange = /*#__PURE__*/ React__namespace.forwardRef((props, ref)=>{
    const { rangeProps } = useSliderContext();
    return /*#__PURE__*/ jsxRuntime.jsx(reactPrimitive.Primitive.div, {
        ref: ref,
        ...domUtils.mergeProps(rangeProps, props)
    });
});
SliderRange.displayName = "SliderRange";
const SliderThumb = /*#__PURE__*/ React__namespace.forwardRef(({ thumbIndex, ...props }, ref)=>{
    const { getThumbProps, getThumbRef } = useSliderContext();
    const composedRef = reactComposeRefs.composeRefs(ref, getThumbRef(thumbIndex));
    const thumbProps = getThumbProps(thumbIndex);
    return /*#__PURE__*/ jsxRuntime.jsx(reactPrimitive.Primitive.div, {
        ref: composedRef,
        ...domUtils.mergeProps(thumbProps, props)
    });
});
SliderThumb.displayName = "SliderThumb";
const SliderHiddenInput = /*#__PURE__*/ React__namespace.forwardRef(({ thumbIndex, ...props }, ref)=>{
...
const SliderTick = /*#__PURE__*/ React__namespace.forwardRef(({ value, ...props }, ref)=>{
    const { getTickProps } = useSliderContext();
    const tickProps = getTickProps(value);
    return /*#__PURE__*/ jsxRuntime.jsx(reactPrimitive.Primitive.div, {
        ref: ref,
        ...domUtils.mergeProps(tickProps, props)
    });
});
SliderTick.displayName = "SliderTick";
const SliderMarker = /*#__PURE__*/ React__namespace.forwardRef(({ value, ...props }, ref)=>{
    const { getMarkerProps } = useSliderContext();
    const markerProps = getMarkerProps(value);
    return /*#__PURE__*/ jsxRuntime.jsx(reactPrimitive.Primitive.div, {
        ref: ref,
        ...domUtils.mergeProps(markerProps, props)
    });
});
SliderMarker.displayName = "SliderMarker";
const SliderValueIndicatorRoot = /*#__PURE__*/ React__namespace.forwardRef(({ thumbIndex, ...props }, ref)=>{
    const { getValueIndicatorProps } = useSliderContext();
    const { rootProps, rootRef } = getValueIndicatorProps(thumbIndex);
    const composedRef = reactComposeRefs.composeRefs(ref, rootRef);
    return /*#__PURE__*/ jsxRuntime.jsx(reactPrimitive.Primitive.div, {
        ref: composedRef,
...
const SliderValueIndicatorLabel = /*#__PURE__*/ React__namespace.forwardRef(({ thumbIndex, ...props }, ref)=>{
    const { getValueIndicatorProps } = useSliderContext();
    const { labelProps } = getValueIndicatorProps(thumbIndex);
    return /*#__PURE__*/ jsxRuntime.jsx(reactPrimitive.Primitive.span, {
        ref: ref,
        ...domUtils.mergeProps(labelProps, props)
    });
});
