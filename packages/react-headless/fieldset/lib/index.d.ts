...
interface FieldsetRootProps extends PrimitiveProps, react.HTMLAttributes<HTMLDivElement> {
}
declare const FieldsetRoot: react.ForwardRefExoticComponent<FieldsetRootProps & react.RefAttributes<HTMLDivElement>>;
interface FieldsetLabelProps extends PrimitiveProps, react.HTMLAttributes<HTMLDivElement> {
}
declare const FieldsetLabel: react.ForwardRefExoticComponent<FieldsetLabelProps & react.RefAttributes<HTMLDivElement>>;
interface FieldsetDescriptionProps extends PrimitiveProps, react.HTMLAttributes<HTMLSpanElement> {
}
declare const FieldsetDescription: react.ForwardRefExoticComponent<FieldsetDescriptionProps & react.RefAttributes<HTMLSpanElement>>;
interface FieldsetErrorMessageProps extends PrimitiveProps, react.HTMLAttributes<HTMLDivElement> {
}
declare const FieldsetErrorMessage: react.ForwardRefExoticComponent<FieldsetErrorMessageProps & react.RefAttributes<HTMLDivElement>>;

interface UseFieldsetContext extends UseFieldsetReturn {
}
declare const FieldsetProvider: react.Provider<UseFieldsetContext>;
declare function useFieldsetContext<T extends boolean | undefined = true>({ strict, }?: {
    strict?: T;
}): T extends false ? UseFieldsetContext | null : UseFieldsetContext;

declare namespace Fieldset_namespace {
  export { FieldsetDescription as Description, FieldsetErrorMessage as ErrorMessage, FieldsetLabel as Label, FieldsetRoot as Root };
  export type { FieldsetDescriptionProps as DescriptionProps, FieldsetErrorMessageProps as ErrorMessageProps, FieldsetLabelProps as LabelProps, FieldsetRootProps as RootProps };
}

export { Fieldset_namespace as Fieldset, FieldsetDescription, FieldsetErrorMessage, FieldsetLabel, FieldsetProvider, FieldsetRoot, useFieldset, useFieldsetContext };
export type { FieldsetDescriptionProps, FieldsetErrorMessageProps, FieldsetLabelProps, FieldsetRootProps, UseFieldsetContext, UseFieldsetReturn };
