...
interface UseToggleProps extends UseToggleStateProps {
    disabled?: boolean;
}
type UseToggleReturn = ReturnType<typeof useToggle>;
declare function useToggle(props: UseToggleProps): {
    pressed: boolean;
    toggle: () => void;
    stateProps: {
...
interface ToggleRootProps extends UseToggleProps, PrimitiveProps, react.HTMLAttributes<HTMLButtonElement> {
}
declare const ToggleRoot: react.ForwardRefExoticComponent<ToggleRootProps & react.RefAttributes<HTMLButtonElement>>;

interface UseToggleContext extends UseToggleReturn {
}
declare function useToggleContext<T extends boolean | undefined = true>({ strict, }?: {
    strict?: T;
}): T extends false ? UseToggleContext | null : UseToggleContext;

declare namespace Toggle_namespace {
  export { ToggleRoot as Root };
  export type { ToggleRootProps as RootProps };
}

export { Toggle_namespace as Toggle, ToggleRoot, useToggleContext };
export type { ToggleRootProps, UseToggleContext };
