...
declare function useImage(props: UseImageProps): {
    refs: {
...
interface ImageRootProps extends UseImageProps, PrimitiveProps, react.HTMLAttributes<HTMLDivElement> {
}
declare const ImageRoot: react.ForwardRefExoticComponent<ImageRootProps & react.RefAttributes<HTMLDivElement>>;
interface ImageContentProps extends PrimitiveProps, react.ImgHTMLAttributes<HTMLImageElement> {
}
declare const ImageContent: react.ForwardRefExoticComponent<ImageContentProps & react.RefAttributes<HTMLImageElement>>;
interface ImageFallbackProps extends PrimitiveProps, react.HTMLAttributes<HTMLDivElement> {
}
declare const ImageFallback: react.ForwardRefExoticComponent<ImageFallbackProps & react.RefAttributes<HTMLDivElement>>;

interface UseImageContext extends UseImageReturn {
}
declare function useImageContext({ strict }?: {
    strict?: boolean;
}): UseImageContext;

declare namespace Image_namespace {
  export { ImageContent as Content, ImageFallback as Fallback, ImageRoot as Root };
  export type { ImageContentProps as ContentProps, ImageFallbackProps as FallbackProps, ImageRootProps as RootProps };
}

export { Image_namespace as Image, ImageContent, ImageFallback, ImageRoot, useImage, useImageContext };
export type { ImageContentProps, ImageFallbackProps, ImageLoadingStatus, ImageRootProps, UseImageContext, UseImageProps, UseImageReturn };
