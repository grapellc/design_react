...
interface UseCheckboxProps extends UseCheckboxStateProps {
    disabled?: boolean;
    invalid?: boolean;
    required?: boolean;
}
...
interface CheckboxRootProps extends UseCheckboxProps, PrimitiveProps, react.HTMLAttributes<HTMLLabelElement> {
}
declare const CheckboxRoot: react.ForwardRefExoticComponent<CheckboxRootProps & react.RefAttributes<HTMLLabelElement>>;
interface CheckboxControlProps extends PrimitiveProps, react.HTMLAttributes<HTMLDivElement> {
}
declare const CheckboxControl: react.ForwardRefExoticComponent<CheckboxControlProps & react.RefAttributes<HTMLDivElement>>;
interface CheckboxHiddenInputProps extends PrimitiveProps, react.InputHTMLAttributes<HTMLInputElement> {
}
declare const CheckboxHiddenInput: react.ForwardRefExoticComponent<CheckboxHiddenInputProps & react.RefAttributes<HTMLInputElement>>;

interface UseCheckboxContext extends UseCheckboxReturn {
}
declare function useCheckboxContext<T extends boolean | undefined = true>({ strict, }?: {
    strict?: T;
