# @grape_design_react/tailwind3-plugin
...
```bash
npm install @grape_design_react/tailwind3-plugin
```

또는

```bash
yarn add @grape_design_react/tailwind3-plugin
```
...
2. Tailwind CSS 구성 파일에 플러그인을 추가합니다.
   ```js
   // tailwind.config.js
   import seedPlugin from '@grape_design_react/tailwind3-plugin';
...
이 패키지는 Tailwind CSS 3.x 버전에서 사용할 수 있습니다. Tailwind CSS 4.0 이상 버전은 `@grape_design_react/tailwind4`를 사용하세요.
