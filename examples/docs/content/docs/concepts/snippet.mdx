...
Then copy component snippets from the docs (e.g. `grape-design/ui/checkbox`) or import from `@grape-design/react`.
...
CLI 실행 후, `grape-design/ui/*` 디렉토리에 snippet이 생성됩니다. 예를 들어:

```tsx
// grape-design/ui/checkbox.tsx
