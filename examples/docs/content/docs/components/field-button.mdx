---
title: Field Button
description: A field-style button for opening selectors or pickers. Shows the selected value when done.
---

<ComponentExample name="field-button/preview">
  <CodeFromFile path="field-button/preview.tsx" />
</ComponentExample>
...
<ComponentExample name="field-button/basic-usage">
  <CodeFromFile path="field-button/basic-usage.tsx" />
</ComponentExample>
...
<ComponentExample name="field-button/clear-button">
  <CodeFromFile path="field-button/clear-button.tsx" />
</ComponentExample>
...
<ComponentExample name="field-button/value-placeholder">
  <CodeFromFile path="field-button/value-placeholder.tsx" />
</ComponentExample>
...
<ComponentExample name="field-button/form">
  <CodeFromFile path="field-button/form.tsx" />
</ComponentExample>

#### Form and Bottom Sheet

<ComponentExample name="field-button/form-bottom-sheet">
  <CodeFromFile path="field-button/form-bottom-sheet.tsx" />
</ComponentExample>

#### React Hook Form

<ComponentExample name="field-button/react-hook-form-simple">
  <CodeFromFile path="field-button/react-hook-form-simple.tsx" />
</ComponentExample>

#### Multiple Values (React Hook Form (Field Array))

<ComponentExample name="field-button/field-array">
  <CodeFromFile path="field-button/field-array.tsx" />
</ComponentExample>

#### Multiple Values (Native `form`)

<ComponentExample name="field-button/multiple-values">
  <CodeFromFile path="field-button/multiple-values.tsx" />
</ComponentExample>
...
<ComponentExample name="field-button/enabled">
  <CodeFromFile path="field-button/enabled.tsx" />
</ComponentExample>
...
<ComponentExample name="field-button/disabled">
  <CodeFromFile path="field-button/disabled.tsx" />
</ComponentExample>
...
<ComponentExample name="field-button/read-only">
  <CodeFromFile path="field-button/read-only.tsx" />
</ComponentExample>
...
<ComponentExample name="field-button/prefix">
  <CodeFromFile path="field-button/prefix.tsx" />
</ComponentExample>

#### Suffix

<ComponentExample name="field-button/suffix">
  <CodeFromFile path="field-button/suffix.tsx" />
</ComponentExample>

#### Both Affixes

<ComponentExample name="field-button/both-affixes">
  <CodeFromFile path="field-button/both-affixes.tsx" />
</ComponentExample>

#### Indicator

<ComponentExample name="field-button/indicator">
  <CodeFromFile path="field-button/indicator.tsx" />
</ComponentExample>
