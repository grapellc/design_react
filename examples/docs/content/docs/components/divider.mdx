---
title: Divider
description: A visual separator that clearly divides content sections.
---

<ComponentExample name="divider/preview">
  <CodeFromFile path="divider/preview.tsx" />
</ComponentExample>
...
```tsx
import { Divider } from "@grapu-design/react";
```
...
<ComponentExample name="divider/orientation">
  <CodeFromFile path="divider/orientation.tsx" />
</ComponentExample>

### Inset

<ComponentExample name="divider/inset">
  <CodeFromFile path="divider/inset.tsx" />
</ComponentExample>
