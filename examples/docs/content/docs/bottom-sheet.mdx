---
title: Bottom Sheet
description: A modal that slides up from the bottom. Used to show extra information or actions while keeping context.
---

<ComponentExample name="bottom-sheet/preview">
  <CodeFromFile path="bottom-sheet/preview.tsx" />
</ComponentExample>
...
<ComponentExample name="bottom-sheet/trigger">
  <CodeFromFile path="bottom-sheet/trigger.tsx" />
</ComponentExample>
...
<ComponentExample name="bottom-sheet/controlled">
  <CodeFromFile path="bottom-sheet/controlled.tsx" />
</ComponentExample>
...
<ComponentExample name="bottom-sheet/open-change-reason">
  <CodeFromFile path="bottom-sheet/open-change-reason.tsx" />
</ComponentExample>
...
<ComponentExample name="bottom-sheet/header-align">
  <CodeFromFile path="bottom-sheet/header-align.tsx" />
</ComponentExample>
...
<ComponentExample name="bottom-sheet/max-height">
  <CodeFromFile path="bottom-sheet/max-height.tsx" />
</ComponentExample>
...
<ComponentExample name="bottom-sheet/snap-points">
  <CodeFromFile path="bottom-sheet/snap-points.tsx" />
</ComponentExample>
...
<ComponentExample name="bottom-sheet/fade-from-index">
  <CodeFromFile path="bottom-sheet/fade-from-index.tsx" />
</ComponentExample>
...
<ComponentExample name="bottom-sheet/show-handle">
  <CodeFromFile path="bottom-sheet/show-handle.tsx" />
</ComponentExample>
...
<ComponentExample name="bottom-sheet/show-close-button">
  <CodeFromFile path="bottom-sheet/show-close-button.tsx" />
</ComponentExample>
...
<ComponentExample name="bottom-sheet/dismissible">
  <CodeFromFile path="bottom-sheet/dismissible.tsx" />
</ComponentExample>
...
<ComponentExample name="bottom-sheet/with-scroll-fog">
  <CodeFromFile path="bottom-sheet/with-scroll-fog.tsx" />
</ComponentExample>
...
<ComponentExample name="bottom-sheet/bottom-inset">
  <CodeFromFile path="bottom-sheet/bottom-inset.tsx" />
</ComponentExample>
...
<ComponentExample name="bottom-sheet/handle-only">
  <CodeFromFile path="bottom-sheet/handle-only.tsx" />
</ComponentExample>
...
<ComponentExample name="bottom-sheet/skip-animation">
  <CodeFromFile path="bottom-sheet/skip-animation.tsx" />
</ComponentExample>
