---
title: Scroll Fog
description: A visual hint that more content is available in a scrollable area.
---

<ComponentExample name="scroll-fog/preview">
  <CodeFromFile path="scroll-fog/preview.tsx" />
</ComponentExample>
...
<ComponentExample name="scroll-fog/horizontal">
  <CodeFromFile path="scroll-fog/horizontal.tsx" />
</ComponentExample>
...
<ComponentExample name="scroll-fog/size">
  <CodeFromFile path="scroll-fog/size.tsx" />
</ComponentExample>

<ComponentExample name="scroll-fog/sizes">
  <CodeFromFile path="scroll-fog/sizes.tsx" />
</ComponentExample>
...
<ComponentExample name="scroll-fog/all-directions">
  <CodeFromFile path="scroll-fog/all-directions.tsx" />
</ComponentExample>
...
<ComponentExample name="scroll-fog/hide-scrollbar">
  <CodeFromFile path="scroll-fog/hide-scrollbar.tsx" />
</ComponentExample>
