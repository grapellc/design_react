...
- When using SEED components (not [@stackflow/plugin-basic-ui](https://www.npmjs.com/package/@stackflow/plugin-basic-ui)), use `@seed-design/stackflow`’s `useActivityZIndexBase`.
