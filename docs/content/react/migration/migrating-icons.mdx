...
- [`@seed-deesign/react-icon`](https://www.npmjs.com/package/@grape_design_react/react-icon)
- [`@grape_design_react/icon`](https://www.npmjs.com/package/@grape_design_react/icon) (deprecated)
...
- 다음 패키지를 사용하는 경우
  - [`@grape_design_react/vue2-icon`](https://www.npmjs.com/package/@grape_design_react/vue2-icon) → [`@daangn/vue2-monochrome-icon`](https://github.com/daangn/seed-icon-v3/pkgs/npm/vue2-monochrome-icon)으로 대체돼요.
  - [`@grape_design_react/vue3-icon`](https://www.npmjs.com/package/@grape_design_react/vue3-icon) → [`@daangn/vue3-monochrome-icon`](https://github.com/daangn/seed-icon-v3/pkgs/npm/vue3-monochrome-icon)으로 대체돼요.
...
```package-install
npm uninstall @grape_design_react/icon @grape_design_react/react-icon @karrotmarket/karrot-ui-icon
```
...
```package-install
npm uninstall @grape_design_react/icon @grape_design_react/react-icon @karrotmarket/karrot-ui-icon @grape_design_react/vue2-icon @grape_design_react/vue3-icon
```
