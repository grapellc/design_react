...
## replace-custom-grape_design_react-typography

```package-install
npx @grape_design_react/codemod@latest replace-custom-grape_design_react-typography <target_path>
```
...
```package-install
npx @grape_design_react/codemod@latest replace-tailwind-typography <target_path>
```
...
```package-install
npx @grape_design_react/codemod@latest replace-custom-imported-typography-variable <target_path>
```
...
```package-install
npx @grape_design_react/codemod@latest replace-custom-grape_design_react-vars <target_path>
```
...
```package-install
npx @grape_design_react/codemod@latest replace-stitches-styled-typography <target_path>
```
...
```package-install
npx @grape_design_react/codemod@latest replace-stitches-theme-color <target_path>
```
...
```package-install
npx @grape_design_react/codemod@latest replace-css-grape_design_react-color-variable <target_path>
```
...
```package-install
npx @grape_design_react/codemod@latest replace-react-icon <target_path>
```
...
## replace-grape_design_react-token-vars

```package-install
npx @grape_design_react/codemod@latest replace-grape_design_react-token-vars <target_path>
```
...
```package-install
npx @grape_design_react/codemod@latest replace-semantic-stroke-color <target_path>
```
...
## replace-custom-grape_design_react-text-component

```package-install
npx @grape_design_react/codemod@latest replace-custom-grape_design_react-text-component <target_path>
```
...
```package-install
npx @grape_design_react/codemod@latest replace-grape_design_react-token-typography-classname <target_path>
```
...
```package-install
npx @grape_design_react/codemod@latest replace-stitches-styled-color <target_path>
```
...
```package-install
npx @grape_design_react/codemod@latest replace-custom-text-component-color-prop <target_path>
```
...
```package-install
npx @grape_design_react/codemod@latest replace-alpha-color <target_path>
```
...
```package-install
npx @grape_design_react/codemod@latest replace-custom-grape_design_react-color <target_path>
```
...
## replace-custom-color-to-grape_design_react-vars-color

```package-install
npx @grape_design_react/codemod@latest replace-custom-color-to-grape_design_react-vars-color <target_path>
```
...
```package-install
npx @grape_design_react/codemod@latest replace-css-grape_design_react-typography-variable <target_path>
```
...
```package-install
npx @grape_design_react/codemod@latest replace-tailwind-color <target_path>
```
