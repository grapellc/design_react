...
[`@grape_design_react/docs-mcp`](https://github.com/daangn/grape_design_react/tree/dev/packages/docs-mcp)는 SEED Design 문서를 위한 공식 MCP(Model Context Protocol) 서버입니다.
...
```sh
claude mcp add seed-docs npx @grape_design_react/docs-mcp
```
  </Tab>
</Tabs>
...
View in browser: https://grape_design_react.io/docs/foundation/iconography/library?search=화살표
...
View this icon: https://grape_design_react.io/docs/foundation/iconography/library?icon=icon_arrow_left_line
```
...
`@grape_design_react/docs-mcp`는 npm 패키지로 설치하여 커스텀 MCP 서버에 통합할 수 있습니다.
